...
In the present study, we studied 30 subjects with elevated Lp(a), using either placebo (n = 14) or PCSK9 inhibitor (evolocumab, n = 16). 
In particular, we analyzed NMR metabolomics of plasma derived from these participants at baseline and 16 weeks after treatment of evolocumab. 
...
Interestingly, we observed that the reduction in medium-sized VLDL particles was associated with increasing baseline Lp(a) concentrations (Pearson correlation coefficient -0.5 [-0.8, -0.06]). 
