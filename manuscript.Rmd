...
In the present study, we aim to study metabolic effects of PCSK9 inhibition with evolocumab in subjects with elevated Lp(a). 
To this end, we studied 30 subjects with elevated Lp(a), using either placebo (n = 14) or PCSK9 inhibitor (evolocumab, n = 16). 
We analyzed NMR metabolomics of plasma derived from these participants at baseline and 16 weeks after treatment of evolocumab. 
...
The major metabolic effects of PCSK9 inhibition were on lipoproteins and their lipid contents.  
There is little effects on other circulating metabolites such as amino acids and ketone bodies. 
...
This is because the particle concentrations of these two VLDL particles were very low, and the VLDLs of medium and small size were the main carriers of triglycerides (Figure S1). 
...
![Figure S1. Triglycerides in lipoprotein subclasses](./Triglycerides_in_lipoproteins.png)
...
However, those tendencies had large uncertainty due to considerable number of missing observations caused by very low concentrations that were below the detection limit (Figure S2). 

![Figure S2 Particle concentrations of VLDLs.](./VLDL_particle_concentrations.png)
